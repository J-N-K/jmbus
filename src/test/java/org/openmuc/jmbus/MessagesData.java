...
public class MessagesData {
    /** RESP-UD EMH DIZ */
    static final ArrayList<byte[]> testMsg1 = new ArrayList<>(Arrays.asList(new byte[] {
        (byte) 0x68,
        (byte) 0x21,
        (byte) 0x21,
        (byte) 0x68,
    ...
    static final ArrayList<byte[]> testMsg2 = new ArrayList<>(Arrays.asList(new byte[] {
        (byte) 0x68,
        (byte) 0x32,
        (byte) 0x32,
        (byte) 0x68,
    ...
    static final ArrayList<byte[]> testMsg3 = new ArrayList<>(Arrays.asList(new byte[] {
        (byte) 0x68,
        (byte) 0x90,
        (byte) 0x90,
        (byte) 0x68,
    ...
    static final ArrayList<byte[]> testMsg4 = new ArrayList<>(Arrays.asList(new byte[] {
        (byte) 0x68,
        (byte) 0x59,
        (byte) 0x59,
        (byte) 0x68,
    ...
    static final ArrayList<byte[]> testMsg5 = new ArrayList<>(Arrays.asList(new byte[] {
        (byte) 0x68,
        (byte) 0x5e,
        (byte) 0x5e,
        (byte) 0x68,
    ...
    static final ArrayList<byte[]> testMsg6 = new ArrayList<>(Arrays.asList(new byte[] {
        (byte) 0x68,
        (byte) 0x50,
        (byte) 0x50,
        (byte) 0x68,
    ...
    /*** TST Heat Meter */
    static final ArrayList<byte[]> testMsg7 = new ArrayList<>(Arrays.asList(new byte[] {
        (byte) 0x68,
        (byte) 0x88,
        (byte) 0x88,
        (byte) 0x68,
    ...
    static final ArrayList<byte[]> testMsg8 =
            new ArrayList<>(Arrays.asList(HexUtils.hexToBytes("6851516808007204000054964EC80F010000000600A50A0000000"
    ...
    static final ArrayList<byte[]> testMsg9 =
            new ArrayList<>(Arrays.asList(HexUtils.hexToBytes("68F9F968081D72295797102D2C18020740000004843BB2FA72000"
    ...
    static final ArrayList<byte[]> testMsg10 =
            new ArrayList<>(Arrays.asList(HexUtils.hexToBytes("68F6F668085D7246201434A34C15027A0000000783FFFF091623"
    ...
    static final ArrayList<byte[]> testMsg12 = new ArrayList<>(Arrays.asList(new byte[] {
        104, -12, -12, 104, 8, 94, 114, -124, 48, 57, 4, -93, 76, 22, 2, 33, 0, 0, 0, 13, -3, 10, 18, 99, 105, 114, 116,
        99, 101, 108, 69, 32, 114, 101, 100, 105, 101, 110, 104, 99, 83, 13, -3, 12, 8, 32, 53, 51, 49, 51, 77, 69, 105,
        13, -3, 14, 7, 50, 48, 48, 46, 52, 46, 49, 3, -3, 23, 0, 0, 0, 5, -3, -36, -1, -1, 1, -98, 38, 44, 64, 5, -3,
        -36, -1, -1, 2, 120, -7, -125, 63, 5, -3, -36, -1, -1, 3, 50, 78, 12, 63, 5, -3, -36, -1, -1, 0, 40, 57, -74,
        63, 5, -3, -55, -1, -1, 5, 56, 12, -55, 67, 5, -3, -55, -1, -1, 6, -105, 49, -54, 67, 5, -3, -55, -1, -1, 7,
        -101, 61, -54, 67, 5, -3, -55, -1, -1, 8, -103, -46, -55, 67, 5, -3, -55, -1, -1, 1, -44, -11, 103, 67, 5, -3,
        -55, -1, -1, 2, -33, 10, 105, 67, 5, -3, -55, -1, -1, 3, -73, 35, 106, 67, 5, -3, -55, -1, -1, 4, 36, 12, 105,
        67, 5, -82, -1, -1, 1, 1, -8, 23, 63, 5, -82, -1, -1, 2, -120, 1, 18, 62, 5, -82, -1, -1, 3, 19, 87, -103, 61,
        5, 46, 69, -93, 79, 63, -123, 64, 46, 100, 108, 0, -65, -123, -128, 64, 46, -72, 36, 116, 63, 5, -1, -1, 10,
        -94, 35, -109, 63, 5, -1, -1, 11
    }));
    ...
    static final ArrayList<byte[]> test_ABB_A41_messages = new ArrayList<>(Arrays.asList(
            test_ABB_A41_Msg1, test_ABB_A41_Msg2, test_ABB_A41_Msg3, test_ABB_A41_Msg4, test_ABB_A41_Msg5));
