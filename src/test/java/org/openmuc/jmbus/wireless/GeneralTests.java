...
public class GeneralTests {
    public Object testData() {
        Object[] p1 = {
            "2644333003000000011B72030000003330011B542000002F2F02FD1701002F2F2F2F2F2F2F2F2F80",
            "LAS",
            1.0,
        ...
        Object[] p2 = {
            "2C44A7320613996707047A2A1000202F2F0C06000000000C14000000000C22381701000B5A1702000B5E1702006E",
            "LUG",
            0.0,
            DataRecord.Description.ENERGY,
            0,
            DataRecord.FunctionField.INST_VAL,
            ""
        };
        ...
        Object[] p3 = {
            "6044961599030023021B7A2B0000202F2F0265A5FA426566FA8201"
                    + "655FFA22650DFA1265C9FA6265FBF95265F2FA02FB1ACC0242FB1A0B038201FB1A040322FB1A850212FB1A270362FB1A810252FB"
                    + "1A380302FD1B30830DFD0F05312E302E310F",
            "ELV",
            -13.71,
            DataRecord.Description.EXTERNAL_TEMPERATURE,
            0,
            DataRecord.FunctionField.INST_VAL,
            ""
        };
        ...
        Object[] p4 = {
            "B244C5149706009503077239099923C514000765009025BAEDCE696A8CB53A2190E402C4AFEBD8865EB6EE"
                    ...
                    + "FFFDCDC30CACF855D48BB99873F192FCD097A2AB03FD0C02032102FD0B111112",
            "EFE",
            0.,
            DataRecord.Description.VOLUME,
            1,
            DataRecord.FunctionField.INST_VAL,
    ...
    public void test(
            ...
            String expectedManId,
            double expectedDataValue,
            Description expectedDesc,
            int dataRecordsIndex,
            DataRecord.FunctionField expectedFunctionField,
            String key)
            throws Exception {
        ...
        DataRecord dataRecord =
                wmBusDataMessage.getVariableDataResponse().getDataRecords().get(dataRecordsIndex);
